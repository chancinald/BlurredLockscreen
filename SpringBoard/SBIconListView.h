...
-(void)unscatterWithDuration:(double)duration startTime:(double)time; //before ios 6.0
-(void)unscatterWithDuration:(double)duration delay:(double)time; // for ios 6.0
...
-(void)layoutIconsNow;
-(id)_transformForIconAtIndex:(unsigned)index inOrientation:(int)orientation;
