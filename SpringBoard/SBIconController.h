...
-(void)_positionFolderViewAndSlidingViewsForFolder:(id)folder notchInfo:(id)info;
...
-(id)_notchInfoForFolderIcon:(id)folderIcon;
...
-(void)_placeIcon:(id)icon inSlidingViewsWithNotchInfo:(id)notchInfo;
