...
@interface SpringBoard : NSObject <UIApplicationDelegate> {
	...
	id _backgroundMIGServerThread;
	id _iconGenerationMIGServerThread;
...
-(void)mediaKeyDown:(id)down;
-(void)mediaKeyUp:(id)up;
-(void)_handleMenuButtonEvent;
-(void)lockButtonDown:(id)down;
...
-(void)_imagesMounted;
-(void)_setDeferredHeadsetButtonDownEvent:(id)event;
-(void)headsetButtonDown:(id)down;
-(void)headsetButtonUp:(id)up;
-(void)headsetAvailabilityChanged:(id)changed;
...
-(void)accessoryKeyStateChanged:(id)changed;
-(unsigned)_frontmostApplicationPort;
-(void)quitTopApplication:(id)application;
-(void)applicationExited:(id)exited;
-(void)anotherApplicationFinishedLaunching:(id)launching;
-(void)applicationSuspend:(id)suspend;
-(void)applicationSuspended:(id)suspended;
-(void)applicationSuspendedSettingsUpdated:(id)updated;
-(void)statusBarReturnActionTap:(id)tap;
...
-(void)_applicationOpenURL:(id)url event:(id)event;
...
-(void)_accessibilityProcessHIDEvent:(id)event;
